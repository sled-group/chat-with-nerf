...
def test_ground_success(
    mocker, session_id, ground_text, visual_grounder, blip2captioner
):
    mocker.patch(
    ...
    result = ground(session_id, ground_text, visual_grounder, blip2captioner)
...
def test_ground_failure(
    ...
    with pytest.raises(Exception, match="Something went wrong."):
        ground(session_id, ground_text, visual_grounder, blip2captioner)
